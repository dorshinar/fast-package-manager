...
use npm::{NpmPackage, NpmPackageVersion, UrlString, Version, VersionRangeSpecifier};
use reqwest::Url;
...
impl<'a, Network: NetworkAdapter + 'a> PackageFetcher<'a, Network> {
    ...
    pub async fn install_package(&self, package_name: &String) -> Result<(), Box<dyn Error>> {
